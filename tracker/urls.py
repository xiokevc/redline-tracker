...
urlpatterns = [
    ...
    # 🧰 ServiceRecord URLs (vehicle_pk used for create, pk for update/delete)
    ...
    # ⏰ Reminder URLs (vehicle_pk used for create, pk for update/delete)
    ...
    # Root redirect → vehicle list
    path('', views.VehicleListView.as_view(), name='vehicle-list-redirect'),
]
